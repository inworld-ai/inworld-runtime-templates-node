...
Examples:
    ...
    yarn node-llm-chat-routing "What is AI?" --auto --models="openai:gpt-4o" --models="openai:gpt-4o-mini" --models="groq:llama-3.3-70b-versatile" --sort=intelligence

    # Auto model selection sorted by price
    yarn node-llm-chat-routing "Tell me a joke" --auto --models="openai:gpt-4o" --models="openai:gpt-4o-mini" --sort=price
    `;
