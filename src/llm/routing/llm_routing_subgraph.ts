...
const usage = `
Usage:
    npm run llm-routing-subgraph "Tell me a joke" -- [--simulateFailure]

Examples:
    # Normal operation with fallback
    npm run llm-routing-subgraph "Tell me a short joke"

    # Simulate failure to test fallback mechanism
    npm run llm-routing-subgraph "Tell me a short joke" -- --simulateFailure
`;
