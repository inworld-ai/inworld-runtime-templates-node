...
const usage = `
Usage:
    npm run node-custom-mcp "What's the weather like in San Francisco?" -- --modelName=gpt-4o-mini --provider=openai --port=8080
...
Example:
    npm run node-custom-mcp "What's the weather like in San Francisco?" -- --modelName=gpt-4o-mini --provider=openai --port=8080
    npm run node-custom-mcp "What's the google stock price today?" -- --modelName=gpt-4o-mini --provider=openai --port=8080
`;
