...
const usage = `
Usage:
    npm run node-mcp-list-tools -- [--server=everything|brave-stdio|brave] [--port=<port>] [--help]
...
Examples:
    npm run node-mcp-list-tools -- --server=everything --port=3001
    npm run node-mcp-list-tools -- --server=brave --port=8080
    npm run node-mcp-list-tools -- --server=brave-stdio`;
