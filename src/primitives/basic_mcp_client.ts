 ...
 *
 * Usage:
 * npm run basic-mcp-client -- --mode=basic
 * npm run basic-mcp-client -- --mode=tools --server=http://localhost:3000
 * npm run basic-mcp-client -- --mode=batch
 * npm run basic-mcp-client -- --mode=integration
 */
