 ...
 * npm run error-handling-fallback "Hello" -- --modelName="invalid-model-name"
 */

const usage = `
Usage:
    npm run error-handling-fallback "Your prompt here" --  \n
...
Examples:
    ...
    npm run error-handling-fallback "Complete this: AI is"
...
async function run() {
  ...
  const fallbackNode = new RemoteLLMChatNode({
  ...
  const primaryNode = new RemoteLLMChatNode({
