...
const usage = `
Usage:
    yarn error-handling-circuit-breaker "Your prompt here" \n
...
Examples:
    ...
    yarn error-handling-circuit-breaker "Explain circuit breakers"
    
    # In production, circuit breaker activates after repeated failures
    yarn error-handling-circuit-breaker "Test"
`;
