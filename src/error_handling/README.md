...
yarn error-handling-circuit-breaker "Tell me about AI"
```
...
yarn error-handling-advanced "What is resilient system design?"

# Test error handling chain
yarn error-handling-advanced "Test" --modelName="invalid-model"
```
