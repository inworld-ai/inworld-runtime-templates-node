 ...
 * yarn error-handling-basic-retry "Complete this sentence: The quick brown"
 *
 * # Test retry behavior with an unavailable model (will retry 3 times)
 * yarn error-handling-basic-retry "Hello" --modelName="invalid-model-name"
 *
 * # Use a different provider
 * yarn error-handling-basic-retry "Test" --provider="openai"
 */

const usage = `
Usage:
    yarn error-handling-basic-retry "Your prompt here" \n
...
Examples:
    # Basic retry example
    yarn error-handling-basic-retry "Complete this: The sky is"
    
    # Test with unavailable model (demonstrates retry)
    yarn error-handling-basic-retry "Test" --modelName="invalid-model"
`;
