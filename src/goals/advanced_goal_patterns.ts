...
const usage = `
Usage:
    yarn advanced-goal-patterns "I need help with my account" \\n
...
Examples:
    ...
    yarn advanced-goal-patterns "I need to reset my password" --scenario=customer_support
    
    # Multi-goal scenario with complex dependencies
    yarn advanced-goal-patterns "I want to start the onboarding" --scenario=multi_goal
    
    # Repeatable goals scenario
    yarn advanced-goal-patterns "What's the weather?" --scenario=repeatable
`;
