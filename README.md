...
- **[routing/](llm/routing/)** - Intelligent routing and conditional logic
- **[tools/](llm/tools/)** - Function calling and MCP integration
...
1. Start with basic LLM examples in [llm/](llm/)
2. Try voice processing in [voice/](voice/)
3. Explore streaming patterns in [streaming/](streaming/)

### Building a Chatbot?
1. [llm/llm_chat.ts](llm/llm_chat.ts) - Basic LLM chat
2. [llm/tools/mcp_call_tool.ts](llm/tools/mcp_call_tool.ts) - Add function calling
3. [llm/routing/llm_output_routing.ts](llm/routing/llm_output_routing.ts) - Add routing logic
4. [safety/safety_pipeline.ts](safety/safety_pipeline.ts) - Add content moderation

### Building a Voice Agent?
1. [voice/speech_to_text.ts](voice/speech_to_text.ts) - STT
2. [voice/text_to_speech.ts](voice/text_to_speech.ts) - TTS
3. [voice_agent/README.md](voice_agent/README.md) - Full application

### Adding RAG?
1. [retrieval/knowledge_retrieval.ts](retrieval/knowledge_retrieval.ts) - Basic RAG
2. [retrieval/intent_matching.ts](retrieval/intent_matching.ts) - Intent matching
3. [retrieval/knowledge_routing.ts](retrieval/knowledge_routing.ts) - Route based on context
