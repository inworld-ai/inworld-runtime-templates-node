...
import { generateExecutionId } from '@inworld/runtime/common';
import {
  configureMetric,
  initTelemetry,
  logger,
...
Options:
    ...
    --exporterType=<Local|Remote>[optional, default=Remote] \n
...
async function runMetricsDemo() {
  ...
  try {
    ...
    configureMetric({
      metricType: MetricType.HistogramUInt,
    ...
    configureMetric({
      metricType: MetricType.GaugeInt,
